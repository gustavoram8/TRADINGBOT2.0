...
(function () {
  var T = {
    en: {
      ...
      // Page 5 — the filter (application)
      'p5.eyebrow': 'The filter',
      'p5.title': 'This isn’t for <span class="accent">everyone.</span>',
      'p5.lead': 'Seats are few and attention is expensive. A short application keeps the room serious — tell us where you are, and we’ll tell you honestly whether this can help.',
      'p5.fname': 'Name',
      'p5.femail': 'Email',
      ...
      'p5.doneTitle': 'Application received.',
      'p5.doneBody': 'It will be reviewed personally — every single one is. If the room fits where you are, you’ll hear from us by email with the next step.',
      'p5.doneCta': 'Back to the app'
    },
    es: {
      ...
      // Página 5 — el filtro (aplicación)
      'p5.eyebrow': 'El filtro',
      'p5.title': 'Esto no es para <span class="accent">todo el mundo.</span>',
      'p5.lead': 'Los cupos son pocos y la atención cuesta cara. Una aplicación corta mantiene la sala en serio — cuéntanos dónde estás, y te diremos con honestidad si esto puede ayudarte.',
      'p5.fname': 'Nombre',
      'p5.femail': 'Correo',
      ...
      'p5.doneTitle': 'Aplicación recibida.',
      'p5.doneBody': 'Se revisará personalmente — todas lo son. Si la sala encaja con donde estás, te llegará un correo con el siguiente paso.',
      'p5.doneCta': 'Volver a la app'
    },
    fr: {
      ...
      // Page 5 — le filtre (candidature)
      'p5.eyebrow': 'Le filtre',
      'p5.title': 'Ce n’est pas pour <span class="accent">tout le monde.</span>',
      'p5.lead': 'Les places sont rares et l’attention coûte cher. Une courte candidature garde la salle sérieuse — dis-nous où tu en es, et on te dira honnêtement si cela peut t’aider.',
      'p5.fname': 'Nom',
      'p5.femail': 'E-mail',
      ...
      'p5.doneTitle': 'Candidature reçue.',
      'p5.doneBody': 'Elle sera lue personnellement — chacune l’est. Si la salle correspond à où tu en es, tu recevras un e-mail avec la prochaine étape.',
      'p5.doneCta': 'Retour à l’app'
    },
    pt: {
      ...
      // Página 5 — o filtro (inscrição)
      'p5.eyebrow': 'O filtro',
      'p5.title': 'Isto não é para <span class="accent">todo mundo.</span>',
      'p5.lead': 'As vagas são poucas e a atenção custa caro. Uma inscrição curta mantém a sala séria — conte onde você está, e diremos com honestidade se isto pode ajudar.',
      'p5.fname': 'Nome',
      'p5.femail': 'E-mail',
      ...
      'p5.doneTitle': 'Inscrição recebida.',
      'p5.doneBody': 'Ela será lida pessoalmente — todas são. Se a sala combinar com onde você está, chegará um e-mail com o próximo passo.',
      'p5.doneCta': 'Voltar ao app'
    }
  };
