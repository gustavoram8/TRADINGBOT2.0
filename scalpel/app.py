...
- IDENTIFY THE SPECIFIC VARIANT, not the generic family: the tags are families ("Triangle", "Wedge", "Double Top / Bottom", "Flag / Pennant", "Head & Shoulders"). Name the exact variant on the chart (Triangle → ascending / descending / symmetrical; Wedge → rising / falling; Double → top vs bottom) and judge THAT variant's own bias, volume signature and measured move. If the shape doesn't match the tagged family, note it gently as a Phase-1-vs-thesis divergence rather than forcing the label.
