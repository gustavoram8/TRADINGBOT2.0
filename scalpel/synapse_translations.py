...
CHROME = {
    'en': {
        ...
        'playbook': 'How it unfolds',
        'fails': 'When it fails',
        'drill': 'How to drill it',
    ...
    'es': {
        ...
        'playbook': 'Cómo se desarrolla',
        'fails': 'Cuándo falla',
        'drill': 'Cómo practicarlo',
        'related': 'Temas conectados',
    ...
    'fr': {
        ...
        'playbook': 'Comment ça se déroule',
        'fails': 'Quand ça échoue',
        'drill': 'Comment le travailler',
        'related': 'Sujets connectés',
        'setup_cond':      'Conditions',
        'setup_entry':     'Entrée',
        'setup_stop':      'Stop',
