...
ANALYSIS PROCESS (this is your PHASE 1 chart read for ICT — work through it FROM THE CHART first, before leaning on the trader's narrative; for Wyckoff / Chart Patterns / Harmonic use that framework's EVALUATION checklist above instead):
